...
export type EvaluationCriterion = { detailId: string; snapshotName?: string | null; studentScore?: number | null; rawMaximumScore?: number | null }
export type StudentEvaluation = { evaluationId: string; subjectTeachingId?: string | null; subjectCode?: string | null; subjectName?: string | null; className?: string | null; semester?: number | null; subjectTeachingExamId?: string | null; questionId?: string | null; teacherName?: string | null; rawType: number; comment?: string | null; rawTotalScore?: number | null; creationDate: string; updatedDate?: string | null; criteria: EvaluationCriterion[] }
export type StudentAnnouncement = { announcementId: string; rawType: number; message: string; creationDate: string; rawStatus: number; enforceRead: boolean; rawNotificationType?: number | null; safeDeepLink?: string | null }
export type StudentDocument = { documentId: string; subjectId: string; subjectCode: string; subjectName: string; rawType: number; name: string; detail: string; safeUrl?: string | null; creationDate: string; updateDate: string }
export type StudentTuition = { tuitionId: string; semesterPlanId: string; semester: number; academicYearName: string; startDate: string; endDate: string; isActivePlan: boolean; rawAmount?: number | null; paidDate?: string | null }
export type FormRequest = { formRequestId: string; formTemplateId?: string | null; formTemplateName?: string | null; safeDocumentUrl?: string | null; creationDate: string; updateDate: string; rawStatus: number; approvalName: string; note: string }
export type StudentFormTemplate = { formTemplateId: string; name: string; safeDocumentUrl?: string | null }
