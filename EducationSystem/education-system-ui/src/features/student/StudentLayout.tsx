import { BellOutlined, BookOutlined, CalendarOutlined, CreditCardOutlined, DashboardOutlined, FileDoneOutlined, FormOutlined, IdcardOutlined, LogoutOutlined, MenuUnfoldOutlined, NotificationOutlined, ProfileOutlined, ReadOutlined, ScheduleOutlined, SolutionOutlined, TrophyOutlined } from '@ant-design/icons'
...
const menuItems = [
  ...
  { key: '/student/resume-builder', icon: <ProfileOutlined />, label: 'CV thông minh' },
...
export function StudentProtectedLayout() {
  ...
  if (restoring) return <div className="center-state"><Spin size="large" description="Đang khôi phục phiên..." /></div>
